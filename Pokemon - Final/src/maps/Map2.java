...
public class Map2 extends Map{
	 ...
	 * Description: 
	 *
	 * setting the tiles in the spot on the maps 
	 * 
	 * @author john and ryan	 
	 */
	public Map2() {
		map = new int[50][50];
	 ...
	 * Description: 
	 *
	 * putting the tiles in the spots on the maps 
	 * 
	 * @param values of coordinte 
	 * 	 
	 */
	 ...
	 * Description: 
	 *
	 * setting the tiles in the spots
	 * 
	 * @param x  coordainte 
	 * @param y  coordinate 
